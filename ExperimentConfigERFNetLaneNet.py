...
class ExperimentConfig(object):
    def __init__(self):
        ...
        self.save_per_iters = self.save_epoch * self.iters_per_epoch
        self.val_per_iters = self.val_epoch * self.iters_per_epoch
